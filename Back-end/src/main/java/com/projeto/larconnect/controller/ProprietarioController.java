...
public class ProprietarioController {
    ...
    public String raizProprietario() {
        return "redirect:/proprietario/dashboard-proprietario";
    }

    @GetMapping("/proprietario/dashboard-proprietario")
    public String dashboardProprietario() {
        return "proprietario/dashboard-proprietario";
    }
}
