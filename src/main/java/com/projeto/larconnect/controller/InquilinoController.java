...
public class InquilinoController {
    ...
    public String raizInquilino() {
        return "redirect:/inquilino/dashboard-inquilino";
    }

    @GetMapping("/inquilino/dashboard-inquilino")
    public String dashboardinquilino() {
        return "inquilino/dashboard-inquilino";
    }
}
